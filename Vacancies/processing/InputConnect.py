import time
from processing.ProcessingModule.Report import Report
...
class InputConnect:
    ...
    def __init__(self):
        ...
        self.get_report(vacancie_name, area_name)

    @profiler
    def get_report(self, vacancie_name: str, area_name: str) -> None:
        """
        Собирает параметры отчета и вызывает формирование отчета
        """
        Report(vacancie_name, area_name)
